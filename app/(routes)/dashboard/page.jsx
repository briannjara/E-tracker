    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-screen bg-gray-900 text-white">
        ...
        <p className="text-xl text-gray-300 mb-8 text-center max-w-2xl mx-auto">
          <span className="font-semibold text-blue-400">Welcome to your dashboard!</span><br />
          It looks like you haven't created any budgets yet.<br />
          <span className="text-green-400">Click the button below to create your first budget and start the tour.</span>
        </p>
        <Link 
    ...
    <div className="bg-gray-900 min-h-screen flex flex-col text-white">
      <main className="flex-grow p-6 md:p-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mt-10">
          <div className="budget-overview bg-gray-800 p-6 rounded-xl shadow-lg border border-gray-700">
            <h2 className="text-2xl font-bold mb-6 text-blue-400">Budget Overview</h2>
            <BarChartDashboard budgetList={budgetList} />
          </div>
          
          <div className="recent-expenses bg-gray-800 p-6 rounded-xl shadow-lg border border-gray-700">
        ...
        <div className="your-budgets mt-10 bg-gray-800 p-6 rounded-xl shadow-lg border border-gray-700">
        ...
        <div className="quick-actions mt-10 bg-gray-800 p-6 rounded-xl shadow-lg border border-gray-700">
